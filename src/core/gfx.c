...
/* the first CTUI_GFX_KITTY_MAX_ROWS entries of kitty's
 * rowcolumn-diacritics.txt */
static const uint32_t g_kitty_diacritics[CTUI_GFX_KITTY_MAX_ROWS] = {
    ...
    0xA6F0, 0xA6F1, 0xA8E0, 0xA8E1, 0xA8E2, 0xA8E3, 0xA8E4};
